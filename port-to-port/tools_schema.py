...
try:
    ...
    ChatCompletionToolParam = Dict[str, Any]  # type: ignore[misc,assignment]
...
class GameClientTool:
    def __init__(self, game_client: Any):
    ...
    def __call__(self, topic: str) -> dict:
        ...
        try:
            fragment_path = (
                ...
                / "game_info_fragments"
                / f"{normalized_topic}.md"
            )
            content = fragment_path.read_text(encoding="utf-8")
            return {"topic": normalized_topic, "content": content}
